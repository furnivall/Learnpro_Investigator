...
df_statmand.loc[df_statmand['ID Number'].isin(long_abs), 'Not at work'] = '>=28 days Absence'
df_statmand.loc[df_statmand['ID Number'].isin(mat), 'Not at work'] = 'Maternity Leave'
df_statmand.loc[df_statmand['ID Number'].isin(secondment), 'Not at work'] = 'Secondment'
